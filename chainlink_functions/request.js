...
const consumerAddress = "0x3E6f168587f9721A31f2FA1a560e6ab36d3B8c69"; // REPLACE this with your Functions consumer address
const subscriptionId = 221; // REPLACE this with your subscription ID
...
const makeRequestSepolia = async () => {
  ...
  const explorerUrl = "https://optimism-sepolia.blockscout.com/";
  ...
  const rpcUrl = process.env.OPTIMISM_SEPOLIA_RPC_URL; // fetch Sepolia RPC URL
